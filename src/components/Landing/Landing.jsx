      ...
      <>
        <Styled.headbanner className="jumbotron">
          <Styled.centerblock>
            ...
            <h3 className="display-3">
              We will help you finding parking spot.
            </h3>
          </Styled.centerblock>
        ...
        <Styled.servicecontainer className="container">
          <div className="mx-auto operation-line">
            ...
            <p>
              Get <Styled.logo>Parkey</Styled.logo>
            </p>
            <hr />
          </div>
          <div className="row">
                ...
                <Styled.service>
                  <div>
                    <img
                      alt="rent"
                      id="rent"
                      src={require("../../images/flyer1.jpg")}
                    />
                  </div>
                  <div className="service-heading">Rent Parking Space </div>
                  <p className="service-description">
                    Now Earn money with Parkey by renting your parking spot for
                    hours, days and month. Parkey will provide a smooth way to
                    interact with people and help you to Earn{" "}
                  </p>
                  <Styled.center>
                    <button
                      type="button"
                ...
                <Styled.service>
                  <div>
                    <img
                      alt="buy"
                      id="buy"
                      src={require("../../images/flyer2.jpg")}
                    />
                  </div>
                  <div className="service-heading">Get Parking Space </div>
                  <p className="service-description">
                    Now with Parkey forget about the stress for finding the
                    parking spot near your current location. Now find parking
                    spot anywhere and anytime using Parkey{" "}
                  </p>
                  <Styled.center>
                    <button
                      type="button"
        ...
        <Styled.midnav className="jumbotron">
          <div className="row">
            ...
            <span className="col-sm-12 col-lg-3 col-md-3">
              How Parkey works?
            </span>
          </div>
        </Styled.midnav>
        ...
        <AuthenticationModal
          ...
          handleSignIn={e => {
            this.setState(state => {
              return { signInModalShow: !state.signInModalShow };
            });
          }}
        />
      </>
