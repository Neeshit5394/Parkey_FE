  ...
  render() {
    ...
    return (
      <div>
          ...
          <nav className="navbar navbar-expand-md navbar-light bg-white">
            ...
            <div className="mx-auto order-0">
              <Link to="/">
                <span className="navbar-brand mx-auto" >
                  <Styled.navbarheading className="display-4"> Parkey </Styled.navbarheading>
                </span>
              </Link>
            ...
            <div className="navbar-collapse collapse w-100 order-3 dual-collapse2">
              <ul className="navbar-nav ml-auto">
                <li className="nav-item">
                  <Styled.navlink className="nav-link" onClick={() => this.signInToggle()} >Sign in or Join</Styled.navlink>
                </li>
                <li className="nav-item">
                  <Link to="/">
        ...
        <Authentication show={this.state.signInModalShow} onHide={() => this.signInToggle()} />
      </div>
    )
  }
}
